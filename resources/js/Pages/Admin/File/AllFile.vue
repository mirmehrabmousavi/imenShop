    ...
    <admin-layout>
        <div class="allPostPanel">
            ...
            <div class="allTable">
                ...
                <div class="showTable">
                    <all-table nameTable="file" :table="posts.data" :labels="labels" :deletes="deletes" :shows="0" :edits="edits" v-on:sendCheck="getCheck" v-on:sendDelete="btnRemoveArray"></all-table>
                </div>
                <div class="paginate">
                    <paginate-panel :link="posts.links"></paginate-panel>
                </div>
