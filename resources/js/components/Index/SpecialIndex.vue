<template>
    <div class="containerCategoriesSuggest width">
        ...
        <div class="containerCategoriesSuggestItem">
            <hooper :settings="hooperSettings">
                <slide v-for="(item , index) in moment.data" :key="index">
                    <inertia-link :href="'/product/' + item.slug" :name="item.title" :title="item.title">
                        <div class="containerCategoriesSuggestItemTitle">
                            {{$t('instant')}}
                        </div>
                        <div class="containerCategoriesSuggestItemPic">
                            <img :src="JSON.parse(item.image)[0]" :alt="item.title">
                        </div>
                        <div class="containerCategoriesSuggestItemSubject" v-if="$i18n.locale == 'fa'">
                        ...
                        <div class="containerCategoriesSuggestItemSubject en" v-if="$i18n.locale == 'en'">
                            <inertia-link :href="'/product/' + item.slug">{{item.titleEn}}</inertia-link>
                            <span>
                                {{item.price|NumFormat}}
                                <span>toman</span>
                            </span>
