<template>
    <div class="allSingleHomeRel" v-if="related.length">
            ...
            <slide v-for="(item , index) in related" :key="index" :title="item.title">
                <inertia-link class="containerCategoriesItem" :href="'/product/' + item.slug">
                    ...
                    <div class="postTitle">
                        ...
                        <inertia-link v-if="$i18n.locale == 'en'" :href="'/product/' + item.slug">{{item.titleEn}}</inertia-link>
                    </div>
                    <div class="postPrice" v-if="item.count >= 1">
                        <div class="postPriceItem" @click.prevent="addCart(item.id)">
                            <i>
